...
# #     recipe_book[name] = {'ingredients': ingredients,
# #                          'instructions': instructions}


# # def search_by_ingredient(ingredient):
# #     matching_recipes = [name for name, recipe in recipe_book.items() if ingredient.lower(
# #     ) in [ingredient.lower() for ingredient in recipe['ingredients']]]
...
# #         shopping_list.update(recipe_book[name]['ingredients'])
# #     return list(shopping_list)


# # # Example Usage:
# # add_recipe('Pasta Carbonara', ['spaghetti', 'eggs', 'bacon', 'parmesan cheese', 'black pepper'],
# #            '1. Cook spaghetti. 2. Fry bacon. 3. Mix eggs with parmesan cheese. 4. Combine all ingredients.')
# # add_recipe('Chicken Stir Fry', ['chicken breast', 'soy sauce', 'vegetables', 'garlic', 'ginger'],
# #            '1. Cook chicken. 2. Stir-fry vegetables. 3. Add soy sauce, garlic, and ginger. 4. Combine all ingredients.')

# # print("Recipe Book:")
# # print(recipe_book)

# # search_result = search_by_ingredient('Chicken')
# # print("\nRecipes containing Chicken:", search_result)

# # shopping_list = generate_shopping_list(search_result)
...
# # Write a Python program that takes a list of numbers as input and returns a dictionary with three keys: 'even', 'odd', and 'prime'. The 'even' key should have a list of all even numbers from the input, the 'odd' key should have a list of all odd numbers, and the 'prime' key should have a list of all prime numbers.
